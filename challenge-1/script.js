...
const firstHolidayTimestamp = Math.min(
    new Date(holidaysCopy[0].date).getTime(),
    new Date(holidaysCopy[1].date).getTime(),
    new Date(holidaysCopy[2].date).getTime(),
    new Date(holidaysCopy[3].date).getTime(),
    new Date(holidaysCopy[4].date).getTime(),
    new Date(holidaysCopy[5].date).getTime(),
    new Date(holidaysCopy[6].date).getTime(),
    new Date(holidaysCopy[7].date).getTime(),
    new Date(holidaysCopy[8].date).getTime(),
